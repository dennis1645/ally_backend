                    ...
                    <tr>
                        <td class="content">
                            ...
                            <div class="status-center">
                                <span class="status-badge">Akun Mentor Aktif</span>
                            </div>

                            <p>
                                Akun Mentor Anda telah berhasil dibuat oleh Administrator kami.
                                Berikut adalah detail login Anda:
                            </p>

                            <div class="credential-box">
                                <p class="info-label">Kredensial Login</p>
                                <div class="cred-row">
                                    <p class="cred-key">Email</p>
                                    <span class="cred-value">{{ $user->email }}</span>
                                </div>
                                <div class="cred-row">
                                    <p class="cred-key">Password Sementara</p>
                            ...
                            <div class="security-notice">
                                <p>
                                    🔒 <strong>Penting:</strong> Segera ubah password Anda setelah berhasil
                                    login pertama kali melalui menu profil. Jangan bagikan kredensial ini
                                    kepada siapa pun demi keamanan akun Anda.
                                </p>
                            </div>

                            <p>Silakan gunakan kredensial di atas untuk login ke dalam platform.</p>
