...
<title>Permintaan Revisi Tugas</title>
<!--[if mso]>
<noscript>
<xml>
        ...
        <tr>
            <td align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" class="main">
                    ...
                    <tr>
                        <td class="content">
                            <h2>Halo, {{ $mentee->name }}! 👋</h2>
                            <p>
                                Mentor Anda (<strong>{{ $mentorName }}</strong>) telah memeriksa tugas <span class="highlight">{{ $milestone->task_name }}</span> dan memberikan catatan revisi.
                            </p>

                            <div class="feedback-box">
                                <div class="feedback-title">📌 Catatan Feedback Mentor:</div>
                                <div class="feedback-text">"{{ $feedback }}"</div>
                            </div>

                            <p style="font-size: 14px; color: #6B7280;">
                                Silakan perbaiki jawaban/dokumen Anda dan kirimkan kembali melalui aplikasi ALLY.
                            </p>
                        </td>
                    </tr>
