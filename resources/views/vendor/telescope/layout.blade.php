...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <button class="btn btn-muted mr-3 d-flex align-items-center py-2" :class="{active: autoLoadsNewEntries}" v-on:click.prevent="autoLoadNewEntries" title="Auto load entries (Live Stream)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
            ...
            <!-- Logout Button untuk Telescope Admin -->
            <form action="{{ route('telescope.logout') }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-danger d-flex align-items-center py-2 px-3" title="Logout Admin Telescope" style="background-color: #EF4444; border-color: #EF4444; font-weight: 600; border-radius: 8px;">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon mr-1" fill="currentColor" style="width:16px;height:16px;">
                        <path fill-rule="evenodd" d="M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0113 4.25v2a.75.75 0 01-1.5 0v-2a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-2a.75.75 0 011.5 0v2A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 013 15.75V4.25z" clip-rule="evenodd" />
                        <path fill-rule="evenodd" d="M19 10a.75.75 0 00-.75-.75H8.5a.75.75 0 000 1.5h9.75A.75.75 0 0019 10z" clip-rule="evenodd" />
                        <path fill-rule="evenodd" d="M15.22 13.28a.75.75 0 001.06 0l3-3a.75.75 0 000-1.06l-3-3a.75.75 0 10-1.06 1.06L17.44 10l-2.22 2.22a.75.75 0 000 1.06z" clip-rule="evenodd" />
                    </svg>
