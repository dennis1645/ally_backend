...
class AITimelineService
{
    ...
    private function buildPrompt($data)
    {
        ...
        2. 'task_name': Gunakan format penamaan fase. Contoh: 'Fase 1: Pembuatan Akun', 'Fase 2: Kejar Skor IELTS'. JANGAN gunakan kata 'Minggu' jika jarak waktu target_deadline antar tugas diperkirakan lebih dari 7 hari. Gunakan kata 'Fase' atau 'Tahap'.
        3. 'description': WAJIB gunakan gaya bahasa CHAT MANUSIAWI (Gunakan sapaan seperti 'Halo!', 'Pejuang Beasiswa', dll). Tunjukkan empati, beri semangat, tegur dengan ramah jika dokumen mereka masih kosong, dan berikan tips taktis. 
        4. 'target_deadline': HARUS format YYYY-MM-DD. Tanggal harus logis, berurutan, terdistribusi merata, dan WAJIB berada di dalam rentang {$data['current_date']} hingga {$data['deadline_date']}. Khusus untuk langkah TERAKHIR (Pendaftaran), set tanggalnya sama dengan atau maksimal H-2 dari deadline ({$data['deadline_date']}).
        5. 'is_mandatory': true atau false.
        6. 'xp_reward': Berikan nilai integer antara 50 hingga 100 berdasarkan tingkat kesulitan tugas. Langkah pendaftaran terakhir bisa diberi XP maksimal (100).
